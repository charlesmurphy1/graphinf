...
namespace GraphInf
{
    ...
    void initNestedBlockPrior(py::module &m)
    {
        py::class_<NestedBlockPrior, BlockPrior, PyNestedBlockPrior<>>(m, "NestedBlockPrior")
            ...
            .def("get_nested_state", [](const NestedBlockPrior &self)
                 { return self.getNestedState(); })
            .def(
                "get_nested_state", [](const NestedBlockPrior &self, Level level)
            ...
            .def("get_nested_block_count", [](const NestedBlockPrior &self)
                 { return self.getNestedBlockCount(); })
            .def("get_nested_block_count", [](const NestedBlockPrior &self, Level level)
                 { return self.getNestedBlockCount(level); })
            .def("get_nested_max_block_count", [](const NestedBlockPrior &self)
                 { return self.getNestedMaxBlockCount(); })
            .def("get_nested_max_block_count", [](const NestedBlockPrior &self, Level level)
                 { return self.getNestedMaxBlockCount(level); })
            .def("get_nested_effective_block_count", [](const NestedBlockPrior &self)
                 { return self.getNestedEffectiveBlockCount(); })
            .def("get_nested_effective_block_count", [](const NestedBlockPrior &self, Level level)
                 { return self.getNestedEffectiveBlockCount(level); })
            .def("get_nested_vertex_counts", [](const NestedBlockPrior &self)
                 { return self.getNestedVertexCounts(); })
            .def("get_nested_vertex_counts", [](const NestedBlockPrior &self, Level level)
                 { return self.getNestedVertexCounts(level); })
            .def("get_nested_abs_vertex_counts", [](const NestedBlockPrior &self)
                 { return self.getNestedAbsVertexCounts(); })
            .def("get_nested_abs_vertex_counts", [](const NestedBlockPrior &self, Level level)
                 { return self.getNestedAbsVertexCounts(level); })
            .def("get_block_of_id", [](const NestedBlockPrior &self, BaseGraph::VertexIndex vertex, Level level)
                 { return self.getBlock(vertex, level); })
            .def("get_nested_block_of_id", [](const NestedBlockPrior &self, BlockIndex vertex, Level level)
