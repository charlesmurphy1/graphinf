...
ext_modules = [
    Extension(
        ...
        sources=[
            ...
            "_graphinf/src/proposer/sampler/vertex_sampler.cpp",
            "_graphinf/src/proposer/sampler/edge_sampler.cpp",
            "_graphinf/src/proposer/sampler/label_sampler.cpp",
            "_graphinf/src/proposer/edge/util.cpp",
            "_graphinf/src/proposer/edge/edge_proposer.cpp",
            "_graphinf/src/proposer/edge/double_edge_swap.cpp",
            "_graphinf/src/proposer/edge/hinge_flip.cpp",
            "_graphinf/src/proposer/edge/single_edge.cpp",
            "_graphinf/src/proposer/edge/labeled_edge_proposer.cpp",
            "_graphinf/src/proposer/edge/labeled_double_edge_swap.cpp",
            "_graphinf/src/proposer/edge/labeled_hinge_flip.cpp",
            "_graphinf/src/proposer/label/uniform.cpp",
            "_graphinf/src/proposer/label/mixed.cpp",
